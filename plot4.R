...
##                                                                                      ##
## Output: The chart 'plot4', the file 'data/070201-02_household_power_consumption.txt' ##           ##
##                                                                                      ##
## Version:                                                                             ##
...
# Set parameter for 4 charts on one canevas.
par(mfrow=c(2,2))
# Build Top left chart (plot 2)
# No label on X axis, line type.
plot(PowerCons$Date, PowerCons$GlobalActivePower, xlab ='',
     ylab='Global Active Power (kilowatts)', type='l')
# Build Top right chart (voltage)
plot(PowerCons$Date, PowerCons$Voltage, xlab='datetime', ylab='Voltage', type='l')
# Build Bottom left chart (plot 3)
...
# No border to be drawn around legend box, this time.
legend('topright', legend=ChartLegend, col=Colors, lty='solid', bty = "n")
# Build Bottom right chart (GlobalReactivePower)
plot(PowerCons$Date, PowerCons$GlobalReactivePower, xlab='datetime',
